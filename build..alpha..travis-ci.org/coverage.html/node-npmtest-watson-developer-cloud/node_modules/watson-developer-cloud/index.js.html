...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >      if (serviceName.indexOf('alchemy_') === 0) {</span>
<span class="cstat-no" title="statement not covered" >        options.version = 'v1';</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      const Service = servicesByVersion[serviceName][options.version];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!Service) {</span>
<span class="cstat-no" title="statement not covered" >        throw new Error('Unable to find ' + serviceName + ' version ' + options.version);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return new Service(options);</span>
    }
  });
});
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      throw new Error('The ' + serviceName + ' service is no longer available');</span>
    }
  });
});
&nbsp;
