...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/text-to-speech/v1.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/text-to-speech/v1.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/text-to-speech/</a> &#187; v1.js</div>
</div>
<div class="body">
 ...
 * @constructor
 */
<span class="fstat-no" title="function not covered" >function TextToSpeechV1(options) {</span>
 ...
 */
TextToSpeechV1.prototype.synthesize = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = extend({ accept: 'audio/ogg; codecs=opus' }, params);</span>
&nbsp;
 ...
 * @param {Function} callback
 */
TextToSpeechV1.prototype.voices = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
      method: 'GET',
      url: '/v1/voices',
 ...
 * @param {String} [params.customization_id]
 */
TextToSpeechV1.prototype.voice = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
 ...
 */
TextToSpeechV1.prototype.pronunciation = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    requiredParams: ['text'],
    options: {
      method: 'GET',
 ...
 * @param {Function} callback
 */
TextToSpeechV1.prototype.createCustomization = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    requiredParams: ['name'],
    options: {
      method: 'POST',
 ...
 * @param {Function} callback
 */
TextToSpeechV1.prototype.updateCustomization = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
 ...
 * @param {Function} callback
 */
TextToSpeechV1.prototype.getCustomizations = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
 ...
 * @param {Function} callback
 */
TextToSpeechV1.prototype.getCustomization = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
 ...
 * @param {Function} callback
 */
TextToSpeechV1.prototype.deleteCustomization = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    requiredParams: ['customization_id'],
    originalParams: params,
    options: {
 ...
 * @param {Function} callback
 */
TextToSpeechV1.prototype.addWords = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    requiredParams: ['customization_id', 'words'],
    originalParams: params,
    options: {
 ...
 * @param {Function} callback
 */
TextToSpeechV1.prototype.addWord = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
 ...
 * @param {Function} callback
 */
TextToSpeechV1.prototype.getWords = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  if (typeof params === 'function' &amp;&amp; !callback) {</span>
<span class="cstat-no" title="statement not covered" >    callback = params;</span>
<span class="cstat-no" title="statement not covered" >    params = {};</span>
  }
 ...
 * @param {Function} callback
 */
TextToSpeechV1.prototype.getWord = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
 ...
 * @param {Function} callback
 */
TextToSpeechV1.prototype.deleteWord = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    requiredParams: ['customization_id', 'word'],
    originalParams: params,
    options: {
