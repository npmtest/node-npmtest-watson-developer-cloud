...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/visual-recognition/v3.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/visual-recognition/v3.js</span></h1>
    <h2>
        
        Statements: <span class="metric">24.85% <small>(42 / 169)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">25% <small>(42 / 168)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/visual-recognition/</a> &#187; v3.js</div>
</div>
<div class="body">
...
1104
1105
1106</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function detectContentType(buffer) {</span>
<span class="cstat-no" title="statement not covered" >  const signature = buffer.readUInt32BE();</span>
<span class="cstat-no" title="statement not covered" >  switch (signature) { // eslint-disable-line default-case</span>
    case 0x504b0304:
    case 0x504b0506:
    case 0x504b0708:
<span class="cstat-no" title="statement not covered" >      return 'application/zip';</span>
    case 0x89504e47:
 ...
 * @param {Object} params
 */
<span class="fstat-no" title="function not covered" >function fixupImageParam(params) {</span>
<span class="cstat-no" title="statement not covered" >  if (params &amp;&amp; params.image_file &amp;&amp; !params.images_file) {</span>
<span class="cstat-no" title="statement not covered" >    params.images_file = params.image_file;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!params || !xor(params.images_file, params.url)) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Watson VisualRecognition.classify() requires either an images_file or a url parameter');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (Buffer.isBuffer(params.images_file)) {</span>
<span class="cstat-no" title="statement not covered" >    params.images_file = {</span>
 ...
 * @return {Function}
 */
<span class="fstat-no" title="function not covered" >function errorFormatter(cb) {</span>
<span class="cstat-no" title="statement not covered" >  const callback = typeof cb === 'function' ? cb /* no op */ : <span class="fstat-no" title="function not covered" >function() {</span>};</span>
...
<span class="cstat-no" title="statement not covered" >        if (result.statusInfo === 'invalid-api-key') {</span>
 ...
 * @constructor
 */
<span class="fstat-no" title="function not covered" >function VisualRecognitionV3(options) {</span>
<span class="cstat-no" title="statement not covered" >  BaseService.call(this, options);</span>
  // Check if 'version_date' was provided
<span class="cstat-no" title="statement not covered" >  if (typeof this._options.version_date === 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('Argument error: version_date was not specified, use 2016-05-20');</span>
  }
<span class="cstat-no" title="statement not covered" >  this._options.qs.version = this._options.version_date; </span>// todo: confirm service expects version not version_date
}
 ...
 * @param {Function} cb
 */
VisualRecognitionV3.prototype.request = <span class="fstat-no" title="function not covered" >function(parameters, cb) {</span>
<span class="cstat-no" title="statement not covered" >  const qs = parameters.options.qs;</span>
...
<span class="cstat-no" title="statement not covered" >    Object.keys(qs).forEach(k =&gt; <span class="cstat-no" title="statement not covered" >Array.isArray(qs[k]) &amp;&amp; (qs[k] = qs[k].join(',')))</span>;</span>
  }
<span class="cstat-no" title="statement not covered" >  return requestFactory(parameters, cb);</span>
};
&nbsp;
/**
 * Grab the api key
 ...
 */
VisualRecognitionV3.prototype.initCredentials = <span class="fstat-no" title="function not covered" >function(options) {</span>
<span class="cstat-no" title="statement not covered" >  options.api_key = options.api_key || options.apikey;</span>
<span class="cstat-no" title="statement not covered" >  options = extend({}, this.getCredentialsFromBluemix(this.name), this.getCredentialsFromEnvironment(this.name), options);</span>
<span class="cstat-no" title="statement not covered" >  if (!options.use_unauthenticated) {</span>
<span class="cstat-no" title="statement not covered" >    if (!options.api_key &amp;&amp; !(options.username &amp;&amp; options.password)) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Argument error: api_key or username/password was not specified');</span>
    }
...
<span class="cstat-no" title="statement not covered" >    options.qs = extend({ api_key: options.api_key }, options.qs);</span>
  }
 ...
 */
VisualRecognitionV3.prototype.getCredentialsFromEnvironment = <span class="fstat-no" title="function not covered" >function(name) {</span>
 ...
 * @return {*}
 */
VisualRecognitionV3.prototype.getCredentialsFromBluemix = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  return BaseService.prototype.getCredentialsFromBluemix.call(this, 'watson_vision_combined');</span>
};
&nbsp;
/**
 ...
 *
 */
VisualRecognitionV3.prototype.classify = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    fixupImageParam(params);</span>
  } catch (e) {
<span class="cstat-no" title="statement not covered" >    callback(e);</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  params = extend(</span>
    {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (params.images_file) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  return this.request(parameters, errorFormatter(callback));</span>
};
&nbsp;
/**
 * Accepts either a url, a single image file, or a zip file with multiple
 ...
 * @return {ReadableStream|undefined}
 */
VisualRecognitionV3.prototype.detectFaces = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    fixupImageParam(params);</span>
  } catch (e) {
<span class="cstat-no" title="statement not covered" >    callback(e);</span>
 ...
 * @return {ReadableStream|undefined}
 */
VisualRecognitionV3.prototype.recognizeText = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  try {</span>
<span class="cstat-no" title="statement not covered" >    fixupImageParam(params);</span>
  } catch (e) {
<span class="cstat-no" title="statement not covered" >    callback(e);</span>
 ...
 * @return {ReadableStream|undefined}
 */
VisualRecognitionV3.prototype.createClassifier = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const example_keys = Object.keys(params).filter(<span class="fstat-no" title="function not covered" >function(key) {</span></span>
<span class="cstat-no" title="statement not covered" >    return key === NEGATIVE_EXAMPLES || key.match(/^.+_positive_examples$/);</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (example_keys.length &lt; 2) {</span>
<span class="cstat-no" title="statement not covered" >    callback(new Error('Missing required parameters: either two *_positive_examples or one *_positive_examples and one negative_examples must be provided.'));</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
  // todo: validate that all *_examples are streams or else objects with buffers and content-types
<span class="cstat-no" title="statement not covered" >  const allowed_keys = ['name', NEGATIVE_EXAMPLES].concat(example_keys);</span>
&nbsp;
 ...
 * @return {ReadableStream|undefined}
 */
VisualRecognitionV3.prototype.retrainClassifier = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const allowed_keys = Object.keys(params).filter(<span class="fstat-no" title="function not covered" >function(key) {</span></span>
<span class="cstat-no" title="statement not covered" >    return key === NEGATIVE_EXAMPLES || key.match(/^.+_positive_examples$/);</span>
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
 ...
 * @return {ReadableStream|undefined}
 */
VisualRecognitionV3.prototype.listClassifiers = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
      method: 'GET',
      url: '/v3/classifiers',
 ...
 * @return {ReadableStream|undefined}
 */
VisualRecognitionV3.prototype.getClassifier = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
      method: 'GET',
 ...
 * @return {ReadableStream|undefined}
 */
VisualRecognitionV3.prototype.deleteClassifier = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
      method: 'DELETE',
      url: '/v3/classifiers/{classifier_id}',
 ...
 * @param {Function} callback
 */
VisualRecognitionV3.prototype.createCollection = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 * @param {Function} callback
 */
VisualRecognitionV3.prototype.getCollection = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 * @param {Function} callback
 */
VisualRecognitionV3.prototype.listCollections = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
 ...
 * @param {Function} callback
 */
VisualRecognitionV3.prototype.deleteCollection = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 * @param {Function} callback
 */
VisualRecognitionV3.prototype.addImage = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!params.image_file || !isStream(params.image_file)) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('image_file param must be a standard Node.js Stream');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 * @param {Function} callback
 */
VisualRecognitionV3.prototype.listImages = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 * @param {Function} callback
 */
VisualRecognitionV3.prototype.getImage = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 * @param {Function} callback
 */
VisualRecognitionV3.prototype.deleteImage = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 * @param {Function} callback
 */
VisualRecognitionV3.prototype.setImageMetadata = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 * @param {Function} callback
 */
VisualRecognitionV3.prototype.getImageMetadata = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 * @param {Function} callback
 */
VisualRecognitionV3.prototype.deleteImageMetadata = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 * @return {ReadableStream|undefined}
 */
VisualRecognitionV3.prototype.findSimilar = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!params.image_file || !isStream(params.image_file)) {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error('image_file param must be a standard Node.js Stream');</span>
