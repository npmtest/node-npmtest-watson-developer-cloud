...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/discovery/v1.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/discovery/v1.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/discovery/</a> &#187; v1.js</div>
</div>
<div class="body">
 ...
 * @constructor
 */
<span class="fstat-no" title="function not covered" >function DiscoveryV1(options) {</span>
...
<span class="cstat-no" title="statement not covered" >    throw new Error('Argument error: version_date was not specified, use DiscoveryV1.VERSION_DATE_2016_12_15');</span>
  }
 ...
 * @param {Object} params
 */
DiscoveryV1.prototype.getEnvironments = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
 ...
 */
DiscoveryV1.prototype.createEnvironment = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
  // size is an int of 1,2,3, default 1
<span class="cstat-no" title="statement not covered" >  if (!params.size) {</span>
<span class="cstat-no" title="statement not covered" >    params.size = 1;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 */
DiscoveryV1.prototype.getEnvironment = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 * @param {String} params.environment_id
 */
DiscoveryV1.prototype.deleteEnvironment = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 * @param {String} params.environment_id
 */
DiscoveryV1.prototype.getConfigurations = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 */
DiscoveryV1.prototype.getConfiguration = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 * @param {String} params.environment_id
  */
DiscoveryV1.prototype.getCollections = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 */
DiscoveryV1.prototype.getCollection = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 */
DiscoveryV1.prototype.createCollection = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  params.language_code = params.language_code || 'en_us';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
      url: '/v1/environments/{environment_id}/collections',
 ...
 */
DiscoveryV1.prototype.deleteCollection = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  params.language_code = params.language_code || 'en_us';</span>
&nbsp;
 ...
 */
DiscoveryV1.prototype.addDocument = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const queryParams = pick(params, ['configuration_id']);</span>
<span class="cstat-no" title="statement not covered" >  const formDataParams = pick(params, ['file', 'metadata']);</span>
&nbsp;
  // if we get a buffer or object, we need to include stuff about filename for the service
<span class="cstat-no" title="statement not covered" >  if (formDataParams.file) {</span>
...
<span class="cstat-no" title="statement not covered" >      const filedat = formDataParams.file;</span>
      // the filename used below is because the name must exist
<span class="cstat-no" title="statement not covered" >      formDataParams.file = { value: filedat, options: { filename: '_' } };</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
 ...
 * @return {ReadableStream|undefined}
 */
DiscoveryV1.prototype.updateDocument = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const queryParams = pick(params, ['configuration_id']);</span>
<span class="cstat-no" title="statement not covered" >  const formDataParams = pick(params, ['file', 'metadata']);</span>
 ...
 * @return {ReadableStream|undefined}
 */
DiscoveryV1.prototype.deleteDocument = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 */
DiscoveryV1.prototype.query = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
