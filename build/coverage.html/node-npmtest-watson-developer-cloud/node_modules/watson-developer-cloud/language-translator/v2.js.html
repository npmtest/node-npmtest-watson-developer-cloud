...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/language-translator/v2.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/language-translator/v2.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/language-translator/</a> &#187; v2.js</div>
</div>
<div class="body">
 ...
 * @constructor
 */
<span class="fstat-no" title="function not covered" >function LanguageTranslatorV2(options) {</span>
...
<span class="cstat-no" title="statement not covered" >    const err = new Error(</span>
 ...
 */
LanguageTranslatorV2.prototype.getModels = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
 ...
 */
LanguageTranslatorV2.prototype.getModel = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 */
&nbsp;
LanguageTranslatorV2.prototype.createModel = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const missingParams = helper.getMissingParams(params, ['base_model_id']);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  const inputTypes = ['forced_glossary', 'parallel_corpus', 'monolingual_corpus'];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (const type in inputTypes) {</span>
<span class="cstat-no" title="statement not covered" >    if (inputTypes.hasOwnProperty(type)) {</span>
<span class="cstat-no" title="statement not covered" >      if (params[inputTypes[type]] &amp;&amp; !isStream(params[inputTypes[type]])) {</span>
<span class="cstat-no" title="statement not covered" >        callback(new Error(inputTypes[type] + ' is not a standard Node.js Stream'));</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
    }
  }
 ...
 * @param  {string}   params.model_id   The model identifier
 */
LanguageTranslatorV2.prototype.deleteModel = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 */
LanguageTranslatorV2.prototype.translate = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!(params.model_id || params.source &amp;&amp; params.target)) {</span>
<span class="cstat-no" title="statement not covered" >    callback(new Error('Missing required parameters: model_id or source and target'));</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 */
LanguageTranslatorV2.prototype.getIdentifiableLanguages = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  params = params || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
 ...
 */
LanguageTranslatorV2.prototype.identify = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  if (!params || !params.text) {</span>
<span class="cstat-no" title="statement not covered" >    callback(new Error('Missing required parameters: text'));</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
