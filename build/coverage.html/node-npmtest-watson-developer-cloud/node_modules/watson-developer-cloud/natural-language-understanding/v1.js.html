...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/natural-language-understanding/v1.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/natural-language-understanding/v1.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-watson-developer-cloud/node_modules/watson-developer-cloud/natural-language-understanding/</a> &#187; v1.js</div>
</div>
<div class="body">
 ...
 * @constructor
 */
<span class="fstat-no" title="function not covered" >function NaturalLanguageUnderstandingV1(options) {</span>
...
<span class="cstat-no" title="statement not covered" >    throw new Error('Argument error: version_date was not specified, use NaturalLanguageUnderstandingV1.VERSION_DATE_2017_02_27');</span>
  }
<span class="cstat-no" title="statement not covered" >  this._options.qs.version = this._options.version_date;</span>
}
 ...
 * @override
 */
NaturalLanguageUnderstandingV1.prototype.getCredentialsFromBluemix = <span class="fstat-no" title="function not covered" >function(name) {</span>
...
/**
  ...
  * @return {void}
  */
NaturalLanguageUnderstandingV1.prototype.analyze = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
...
/**
  ...
  * @return {void}
  */
NaturalLanguageUnderstandingV1.prototype.listModels = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
      url: '/v1/models',
      method: 'GET',
...
/**
  ...
  * @return {void}
  */
NaturalLanguageUnderstandingV1.prototype.deleteModel = <span class="fstat-no" title="function not covered" >function(params, callback) {</span>
<span class="cstat-no" title="statement not covered" >  const parameters = {</span>
    options: {
      method: 'DELETE',
